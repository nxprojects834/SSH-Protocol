...
public class Connection
{
     ...
     * caller-supplied transport already connected by the app.
     */
    private InputStream preconnectedInput;
    private OutputStream preconnectedOutput;
    private Runnable preconnectedClose;
    ...
    /**
     * Supplies an already-established byte transport for the next connect().
     *
     * hostname/port remain the SSH server identity used for key exchange
     * and host-key verification.
     */
    public synchronized void setPreconnectedTransport(
            InputStream input,
            OutputStream output,
            Runnable closeTransport)
    {
        ...
        if (input == null || output == null || closeTransport == null)
            throw new IllegalArgumentException(
                    "Preconnected transport arguments may not be null");

        this.preconnectedInput = input;
        this.preconnectedOutput = output;
        this.preconnectedClose = closeTransport;
    }
